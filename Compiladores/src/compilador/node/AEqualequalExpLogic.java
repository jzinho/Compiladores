...
public final class AEqualequalExpLogic extends PExpLogic
{
    private PExpArith _left_;
    private PExpArith _right_;

    public AEqualequalExpLogic()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEqualequalExpLogic(
    ...
    {
        ((Analysis) sw).caseAEqualequalExpLogic(this);
    }
