...
public interface Analysis extends Switch
{
    ...
    void caseATIdVarDeclId(ATIdVarDeclId node);
    void caseAVarDecl2VarDeclId(AVarDecl2VarDeclId node);
    void caseAVarDecl2(AVarDecl2 node);
    void caseAFunDecl(AFunDecl node);
    void caseADiffCompOp(ADiffCompOp node);
    void caseAEqualCompOp(AEqualCompOp node);
    void caseAGreaterCompOp(AGreaterCompOp node);
    void caseALessCompOp(ALessCompOp node);
    void caseAGequalCompOp(AGequalCompOp node);
    void caseALequalCompOp(ALequalCompOp node);
